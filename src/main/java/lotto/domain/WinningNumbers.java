...
public class WinningNumbers extends Lotto {
    ...
    /**
     * 당첨 번호 리스트와 보너스 번호로 WinningNumbers 객체를 생성합니다. 생성 시 당첨 번호의 유효성(Lotto의 규칙)과 보너스 번호의 유효성(범위, 당첨 번호와의 중복)을 모두 검사합니다.
     *
    ...
    /**
     * 당첨 번호와 보너스 번호 정보를 담은 데이터 전송 객체(DTO)를 반환합니다. 반환되는 객체는 원본 데이터를 수정할 수 없습니다.
     *
