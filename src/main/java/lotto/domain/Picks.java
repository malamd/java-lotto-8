...
public class Picks {
    ...
    /**
     * 구매한 로또 개수만큼 무작위 번호로 로또를 생성하여 초기화합니다. 이 생성자는 실제 애플리케이션 로직에서 사용됩니다.
     *
    ...
    /**
     * 미리 생성된 로또 리스트로 초기화합니다. 이 생성자는 주로 테스트 코드에서 특정 시나리오를 검증하기 위해 사용됩니다.
     *
    ...
    /**
     * 지정된 인덱스에 해당하는 로또의 번호 정보를 반환합니다. 반환되는 객체는 원본 데이터를 수정할 수 없는 DTO(UserNumbersInfo)입니다.
     *
     ...
     * 예: [8, 21, 23, 41, 42, 43] [3, 5, 11, 16, 32, 38]
     *
